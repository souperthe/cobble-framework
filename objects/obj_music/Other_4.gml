...
if roomSecretMusic != undefined
{
    ...
    musicInstanceSecret = audio_play_sound_on(musicEmitter, roomSecretMusic.song, true, 0)
...
if !roomMusic.fade || !audio_is_playing(musicInstanceCurrent)
{
    ...
    musicInstanceCurrent = audio_play_sound_on(musicEmitter, roomMusic.song, true, 0)
    exit
}
...
musicInstanceCurrent = audio_play_sound_on(musicEmitter, roomMusic.song, true, 0, 0)
